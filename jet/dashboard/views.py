...
class UpdateDashboardModuleView(SuccessMessageMixin, UpdateView):
    ...
    def get_success_url(self):
        if self.object.app_label:
            return reverse(
                "admin:app_list", kwargs={"app_label": self.object.app_label}
            )
        else:
    ...
    def get_settings_form_kwargs(self):
        kwargs = {"initial": self.module.settings}
    ...
    def get_children_formset_kwargs(self):
        kwargs = {"initial": self.module.children, "prefix": "children"}
    ...
    def get_context_data(self, **kwargs):
        ...
        data["child_name"] = (
            self.module.child_name if self.module.child_name else _("Items")
        )
        data["child_name_plural"] = (
            self.module.child_name_plural
...
def update_dashboard_module_collapse_view(request):
    ...
    try:
        ...
        form = UpdateDashboardModuleCollapseForm(
            request, request.POST, instance=instance
        )
